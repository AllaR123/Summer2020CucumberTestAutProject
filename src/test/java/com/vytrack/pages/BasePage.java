...
// parent class for all classes. Used to initialize all the objects using Page Factory (for @FindBy)
public abstract class BasePage {                // cannot create obj from this class
