...
public class Driver {
    private static ThreadLocal <WebDriver> driverPool = new ThreadLocal<>();      // ThreadLocal --> we wrap driver with ThreadLocal, with this we can do parallel executing
                                                                                  // bc with Singleton we ONLY can run 1 test, parallel NOT possible
    private Driver() {
    }
...
//                    ChromeOptions chromeOptions = new ChromeOptions();
                            ...
                            URL gridUrl = new URL("http://34.235.167.155:4444/wd/hub");
                    ...
                    case "remote-firefox":
                        try {
                            ...
                            URL gridUrl = new URL("http://34.226.190.75:4444/wd/hub");
                            driverPool.set(new RemoteWebDriver(gridUrl, desiredCapabilities));
                        } catch (Exception e) {
                            e.printStackTrace();
                        }
